...
typedef struct bpatch { // struktura dla wielomiana fragmentu Beziera 3 stopnia
	...
	POINT_3D anchors[4][9]; // siatka 4x4 punktów kontrolnych (anchor)
...
GLuint genBezier(BEZIER_PATCH patch, int divs) {
	...
	temp[0] = patch.anchors[0][4];
	temp[1] = patch.anchors[1][4];
...
double x[9] = { 0.0,-0.64,-0.98,-0.87,-0.34,-0.34,0.87,0.98,0.64 };
